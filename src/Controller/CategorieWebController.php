...
/**
 * @Route("/profile/categorie/web",name="profile_")
 */
class CategorieWebController extends AbstractController
{
    /**
    ...
    {
        return $this->render('categorie_web/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('categorie_web_index');
        }

        return $this->render('categorie_web/new.html.twig', [
    ...
    {
        return $this->render('categorie_web/show.html.twig', [
            'categorie_web' => $categorieWeb,
        ]);
    }
    ...
    public function edit(Request $request, CategorieWeb $categorieWeb): Response
    {
        ...
        return $this->render('categorie_web/edit.html.twig', [
            'categorie_web' => $categorieWeb,
            'form' => $form->createView(),
        ]);
    }
