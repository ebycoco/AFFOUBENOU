...
/**
 * @ORM\Entity(repositoryClass=AutreFonctionnaliteRepository::class)
 * @Vich\Uploadable
 */
class AutreFonctionnalite
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="autreFonctionnalites")
